...
graph TD
    ...
    Hospital -->|Send Verified Request to Navira AI| RouteCalc[Route Calculation]
...
3. **Route Calculation**: Navira AI calculates optimal route considering traffic conditions
